...
from flask_smorest import Blueprint # API 생성
from flask.views import MethodView
from db import db
from models import Board

board_blp = Blueprint('Boards', 'boards', description='Operations om boards', url_prefix='/board')
...
class BoardResource(MethodView):
    ...
    def delete(self,board_id):
        ...
        return jsonify({'msg':"Successfuly deleted board data"}), 204